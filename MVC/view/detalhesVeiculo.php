...
<head>
	<meta charset="UTF-8">
	<title>Motor - detalhes veículo</title>
</head>
<body>
	<?php 
		include ("menu.php"); 
	...
	<form action="../model/reserva.php?id=<?php echo $vChassi ?>"  method="POST">
		<button name="reserva" class="enviar" type="submit" <?php if (!isset($_SESSION["logado"]) || $_SESSION["locadora"]){ $_SESSION["pagina"] = "../view/detalhesVeiculo.php?id=$vChassi"; ?> disabled <?php } ?> >Reservar</button>
	</form>
